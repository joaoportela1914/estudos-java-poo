...
public class Date_Main {
	...
	public static void main(String[] args) {
		...
		Instant d07 = Instant.parse("2026-08-12T01:30:26.0478-03:00");
		
		LocalDate d08 = LocalDate.parse("12/08/2026" , fmt1);
		LocalDateTime d09 = LocalDateTime.parse("12/08/2026 16:44" , fmt2);
